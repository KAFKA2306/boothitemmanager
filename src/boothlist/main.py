...
class BoothListETL:
    ...
    def run(self):
        ...
        # --- Post-processing for Ownership & Mochifitter tags ---
        # 1. Load Mochifitter supported IDs
        mochifitter_ids = set()
        ...
        # Hardcoded overrides if needed for reliability? 
        # Ideally the aliases.yml handles name mapping.
