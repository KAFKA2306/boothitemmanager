...
def validate_api(block: TestBlock) -> Message:
    """
    Validates the API generation result.
    Checks for essential files and their schemas.
    """
    ...
    # Check metrics.json for basic structure if it exists
    metrics_valid = False
