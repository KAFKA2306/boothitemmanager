...
メインエージェントちゃんが「絶対に妥協しない」ための、機械的な監査ルール集合だよっ✨ 推測や曖昧さは一切禁止！すべて PASS か FAIL の二値判定でいくよ💕
...
## 10. 禁止事項
- 重み付け評価（「ここはまあいいか」はダメっ！）
- あいまい評価（「だいたい合ってる」もダメっ！）
- スコアリング
- 推測補完
- 部分合格
...
## 12. システム思想
このチェックリストは「判断基準」ではなく、**“拒否条件の列挙”** である。💕
